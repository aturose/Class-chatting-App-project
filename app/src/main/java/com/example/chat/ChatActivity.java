...
public class ChatActivity extends AppCompatActivity {
        ...
        * user*/
        ...
        userQuery.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                //check until the required info is received
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(message)){
                    //text empty
                    Toast.makeText(ChatActivity.this, "Sorry,you cannot send an empty message", Toast.LENGTH_SHORT).show();
        ...
        ref.child(myUid).child("BlockedUsers").child(hisUid).setValue(hashMap)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        //failed to block
                        Toast.makeText(ChatActivity.this, "User not blocked! Try again."+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
                            ...
                            if (ds.exists()){
                                ...
                                ds.getRef().removeValue()
                                        ...
                                        .addOnFailureListener(new OnFailureListener() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                //failed to unblock
                                                Toast.makeText(ChatActivity.this, "Failed to unblock! Try again."+e.getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        });
                            }
                        }
    ...
    private void sendImageMessage(Uri image_rui) throws IOException {
        ...
        progressDialog.setMessage("Please wait as we send you image...");
        progressDialog.show();
                        ...
                        if (uriTask.isSuccessful()){
                            ...
                            database.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    ...
                                    if (notify){
                                        senNotification(hisUid, user.getName(), "Sent a new post");
                                    }
                                    notify = false;
                    ...
                    try {
                        ...
                        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest("https://fcm.googleapis.com/fcm/send", senderJsonObj,
                            ...
                            protected Map<String, String> getParams() throws AuthFailureError {
                                ...
                                headers.put("Authorization", "key=AAAA1Dvjo38:APA91bFLW98o14erVyMTeAISmJjpZGBJ-WQkJNJNsAHxqD2tRlR01BEAqks6UwbHMoV_5D0jpd88xJ34bFliHFtfF41S1PxcOghtQ7IWXd5FWZAR4kYjBrW0usBvKAT2rk_UFCkgRwtg");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //hider searchview, add post, as we dont need it here
