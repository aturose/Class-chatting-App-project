...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()){
                    ...
                    mEmailEt.setError("The Email entered is Invalid!.Please try again.");
        ...
        notHaveAccntTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LoginActivity.this, com.example.chatapp.RegisterActivity.class));
                finish();
            }
        });
        ...
        pd.setMessage("Please wait while you log in...");
    }
    ...
    private void showRecoverPasswordDialog() {
        ...
        // sets the main width of an editview to fit a text of n 'M' letters regardless of the
    ...
    private void beginRecovery(String email) {
        ...
        pd.setMessage("Please wait while we send email...");
        pd.show();
        mAuth.sendPasswordResetEmail(email)
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(LoginActivity.this, "Password reset Email not sent", Toast.LENGTH_SHORT).show();
                }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            //TO CHANGE LATER TO DIRECT TO ANOTHER ACTIVITY
                            //user is logged in, so start login activity
                            startActivity(new Intent(LoginActivity.this, com.example.chatapp.DashboardActivity.class));
                            finish();
                        } else {
                            //dismiss progress dialog
                            pd.dismiss();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            //got to profile activity after logged in
                            startActivity(new Intent(LoginActivity.this, com.example.chatapp.DashboardActivity.class));
                            finish();
                            //updateUI(user);
                        } else {
