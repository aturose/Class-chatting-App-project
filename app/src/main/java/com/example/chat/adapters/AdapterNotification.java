...
public class AdapterNotification  extends RecyclerView.Adapter<AdapterNotification.HolderNotification>{
    ...
    public void onBindViewHolder(@NonNull final HolderNotification holder, int position) {
        ...
        holder.notBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //show confirmation
                AlertDialog.Builder builder = new AlertDialog.Builder(context);
                builder.setTitle("Delete");
                builder.setMessage("Sure to delete this notification?");
...
//                return false;
    ...
    class HolderNotification extends RecyclerView.ViewHolder{
        ...
        public HolderNotification(@NonNull View itemView) {
            ...
            notBtn = itemView.findViewById(R.id.notBtn);
