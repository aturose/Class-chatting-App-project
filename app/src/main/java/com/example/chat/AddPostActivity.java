...
public class AddPostActivity extends AppCompatActivity {
   ...
   // Uri image_rui;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Post From Here");
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //get data(title, description) fromEditTexts
...
//                }
    ...
    private void beginUpdate(String description, String editPostId) {
        pd.setMessage("Please wait while your post is updating...");
        pd.show();
        ...
        ref.child(editPostId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        pd.dismiss();
                        Toast.makeText(AddPostActivity.this, "Your post was updated successfully.", Toast.LENGTH_SHORT).show();
                        Intent intt = new Intent(AddPostActivity.this,HomeFragment.class);
                        startActivity(intt);
                ...
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        if (uriTask.isSuccessful()){
                            //url is receive, upload to firebse database
                            ...
                            ref.child(editPostId)
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            pd.dismiss();
                                            Toast.makeText(AddPostActivity.this, "Your post was updated successfully.", Toast.LENGTH_SHORT).show();
                                            Intent inttt = new Intent(AddPostActivity.this,HomeFragment.class);
                                            startActivity(inttt);
                                            ...
                                            ref.child(editPostId)
                                                    ...
                                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                        ...
                                                        public void onSuccess(Void aVoid) {
                                                            pd.dismiss();
                                                            Toast.makeText(AddPostActivity.this, "Your post was updated successfully.", Toast.LENGTH_SHORT).show();
                                                            Intent intts = new Intent(AddPostActivity.this,HomeFragment.class);
                                                            startActivity(intts);
    ...
    private void uploadData(final String description) {
        pd.setMessage("Please wait as we add your post...");
        pd.show();
                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                //added in database
                                                pd.dismiss();
                                                Toast.makeText(AddPostActivity.this, "Posted added succesfully", Toast.LENGTH_SHORT).show();
                                                Intent inttss = new Intent(AddPostActivity.this,HomeFragment.class);
                                                startActivity(inttss);
                                                //reset views
                                                //titleEt.setText("");
            ...
            ref.child(timeStamp).setValue(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            pd.dismiss();
                            Toast.makeText(AddPostActivity.this, "Posted added succesfully", Toast.LENGTH_SHORT).show();
                            Intent inttg = new Intent(AddPostActivity.this,HomeFragment.class);
                            startActivity(inttg);
                            //reset views
                            //titleEt.setText("");
                            descriptionEt.setText("");
    ...
    private void prepareNotification(String pId, String title, String description, String notificationType, String notificationTopic){
        ...
        String NOTIFICATION_TITLE =title; //e.g. Antony added new post
    ...
    private void sendPostNotification(JSONObject notificationJo) {
                ...
                })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                //put the required headers
                Map<String, String> headers = new HashMap<>();
                headers.put("Content-Type", "application/json");
                headers.put("Authorization","key=AAAA1Dvjo38:APA91bFLW98o14erVyMTeAISmJjpZGBJ-WQkJNJNsAHxqD2tRlR01BEAqks6UwbHMoV_5D0jpd88xJ34bFliHFtfF41S1PxcOghtQ7IWXd5FWZAR4kYjBrW0usBvKAT2rk_UFCkgRwtg");//paste your fcm key here after "key="
